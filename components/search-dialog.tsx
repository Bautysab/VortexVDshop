...
export function SearchDialog() {
  ...
  const searchResults = {
    games: [
      {
        ...
        price: 39.99,
        tags: ["Action", "Adventure", "PS4 Exclusive"],
      },
      {
        id: 2,
        title: "Spider-Man",
    ...
    categories: [
      ...
      { id: 3, name: "RPG", count: 156 },
    ],
    recent: [
      { id: 1, title: "Horizon Zero Dawn", image: "/placeholder.svg?height=100&width=200" },
      { id: 2, title: "The Last of Us Part II", image: "/placeholder.svg?height=100&width=200" },
    ],
  }
      ...
      <DialogContent className="sm:max-w-[800px] bg-zinc-900 border-zinc-800">
        <DialogHeader>
          ...
          <div className="relative">
            ...
            <Input
              placeholder="Search PS4 games, genres..."
